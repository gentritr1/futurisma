...
import {DreamIslandReflections,applyDreamIslandReflection,DreamIslandGlow,bindDreamIslandNodeMaterials} from './dreamisland-reflections';
...
export class DreamIslandWater {
 ...
 update(elapsed:number,nightBlend:number,reducedMotion:boolean){
  ...
  (this.shallows.material as THREE.MeshLambertMaterial).emissiveIntensity=nightBlend*12.0;
  (this.foam.material as THREE.MeshLambertMaterial).emissiveIntensity=nightBlend*18.0;
 }
}
