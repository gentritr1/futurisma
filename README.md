...
If you want to continue the work: start at [docs/briefs/DREAM-ISLAND-HANDOFF.md](docs/briefs/DREAM-ISLAND-HANDOFF.md) (state detection, verification commands, rules), then the level brief [DREAM-ISLAND-LEVEL.md](docs/briefs/DREAM-ISLAND-LEVEL.md). Sound, a running clock and the power-kit hardware landed in [DREAM-ISLAND-POLISH-3.md](docs/briefs/DREAM-ISLAND-POLISH-3.md). The first human playtest ("feels empty, powers invisible, a dashboard") became [DREAM-ISLAND-ALIVE.md](docs/briefs/DREAM-ISLAND-ALIVE.md): a painted road, toys and chrome at the road edge, bollards that light at the strike, a sea that reflects the sky and sparkles, hovering capsule pickups with a light column, and the island's own aqua-glass HUD with a timing tower and a power slot that teaches you the key. Its review rounds are appended to the brief, with the gates that were wrong and how they were corrected. Evidence for every phase lives under `art/evidence/dreamisland-v1/`.
