...
If you want to continue the work: start at [docs/briefs/DREAM-ISLAND-HANDOFF.md](docs/briefs/DREAM-ISLAND-HANDOFF.md) (state detection, verification commands, rules), then the level brief [DREAM-ISLAND-LEVEL.md](docs/briefs/DREAM-ISLAND-LEVEL.md). Sound, a running clock and the power-kit hardware landed in [DREAM-ISLAND-POLISH-3.md](docs/briefs/DREAM-ISLAND-POLISH-3.md); what remains is a human playtest. Evidence for every phase lives under `art/evidence/dreamisland-v1/`.
