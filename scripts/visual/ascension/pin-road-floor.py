"""Pin a per-sector art guard after recording the unpainted base, never before."""
...
root=Path('art/evidence/ascension-v1/phase-a')
...
result={'script':'scripts/visual/ascension/pin-road-floor.py','measurementScript':'scripts/visual/frame-metrics.py','baseRecordedFirst':'road-luma-base.json','referencePatches':patches,'references':references,'darkestAcceptedTunnelPatch':minimum,'rule':'85% of each sector blockout base, allowing texture shading variation, but never below the darkest measured accepted Tideline tunnel road patch. These are art acceptance floors, not proof of finished-art compliance.','floors':floors}
