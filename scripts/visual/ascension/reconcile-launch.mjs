...
const measured={script:'scripts/visual/ascension/reconcile-launch.mjs',sourceScript:report.script,
 ...
 driving:report.records[0]?.driving?{completedLapCounts:[...new Set(report.records.map(r=>r.driving.lapTimesMs.length))],phases:[...new Set(report.records.map(r=>r.driving.phase))],note:'Two completed laps and running phase establish lap three.'}:null,
