...
try{
 ...
 await writeFile(out+'/capture.json',JSON.stringify({script:'scripts/visual/ascension/stations.mjs',records,errors,roadPatchesBySector:{PAD_ROAD:{under:{x:500,y:430},between:{x:500,y:455}}},roadPatchNote:'Pad Road center pixels intersect the hanging device. Its road patch is moved left onto unobstructed asphalt; all other sector patches retain their positions.',roadPatches:{under:{x:640,y:430},between:{x:640,y:455}}},null,2));if(errors.length)throw Error(errors.join('\n'));
