...
const assets=['rocket-platform','crawler-transporter','countdown-board','trench-wall-module','deluge-water-tower','propellant-tank','vent-stack','crawlerway-gravel-bed','mangrove-pier','egret-card-set','service-tower-swing-arm','surge','shield'];
const out='art/evidence/ascension-v1/phase-b/focal';await mkdir(out,{recursive:true});
